 ...
 * @since 1.1.0
 */
class Time extends Widget_Base {
	...
	public function get_title() {
		return __( 'Zeit', 'elementor-motointermedia' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Das ist eine Headline', 'elementor-motointermedia' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'elementor-motointermedia' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Deine Nachricht', 'elementor-motointermedia' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'elementor-motointermedia' ),
			]
		);
	...
	protected function _content_template() {
		...
		<div {{{ view.getRenderAttributeString( 'date' ) }}}>{{{ settings.date }}}</div>
		<?php
	}
}
